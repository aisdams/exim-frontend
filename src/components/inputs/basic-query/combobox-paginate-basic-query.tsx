...
type ComboboxPaginateBasicQueryProps = {
...
export default function ComboboxPaginateBasicQuery({
  query,
  value,
  setValue,
  inputValue,
  ...
  additionalOnChange = () => {},
  additionalOnClear = () => {},
}: ComboboxPaginateBasicQueryProps) {
  ...
  useEffect(() => {
    if (inView && query.hasNextPage && !value) {
      query.fetchNextPage();
    }
  }, [inView]);
          ...
          >
            ...
            <span
              className={cn(
                ...
                !(value && options) && 'font-normal text-muted-foreground'
              )}
            >
