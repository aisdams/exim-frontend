  ...
  return (
    <div className="flex items-center rounded-lg border px-1 text-sm">
      <input
        ...
        className="w-7 border-none bg-background p-0 text-center outline-none dark:bg-darkBlue"
        placeholder="D"
      />
      ...
      <input
        ...
        className="w-6 border-none bg-background p-0 text-center outline-none dark:bg-darkBlue"
        placeholder="M"
      />
      <span className="-mx-px opacity-20">/</span>
      <input
        ...
        className="w-12 border-none bg-background p-0 text-center outline-none dark:bg-darkBlue"
        placeholder="YYYY"
      />
    </div>
  );
